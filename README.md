...
wget -qO- http://nginxlibrary.com/downloads/perl-fcgi/fastcgi-wrapper | sed -e '/OpenSocket/s/127.0.0.1:8999/\/var\/run\/otrs\/perl_cgi-dispatch.sock/' > /usr/local/bin/fastcgi-wrapper.pl
